  ...
  const getRatingIcon = (r: 1 | 2 | 3) => {
    switch (r) {
      ...
      case 3:
        return (
          <svg className="w-8 h-8" fill="currentColor" viewBox="0 0 20 20">
            <path d="M2 10.5a1.5 1.5 0 003 0v-6a1.5 1.5 0 00-3 0v6zM6 10.333v-5.43a2 2 0 011.105-1.79l.05-.025A4 4 0 018.945 3h5.416a2 2 0 011.962 1.608l1.2 6A2 2 0 0115.56 13H12v4a2 2 0 01-2 2 1 1 0 01-1-1v-.667a4 4 0 00-.8-2.4L6.8 13.067a4 4 0 01-.8-2.4z" />
          </svg>
        );
    }
  };
