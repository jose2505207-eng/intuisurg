  ...
  const getRatingIcon = (r: 1 | 2 | 3) => {
    switch (r) {
      case 1:
        return (
          <svg className="w-8 h-8" fill="currentColor" viewBox="0 0 20 20">
            <path d="M18 9.5a1.5 1.5 0 11-3 0v-6a1.5 1.5 0 013 0v6zM14 9.667v-5.43a2 2 0 00-1.105-1.79l-.05-.025A4 4 0 0011.055 2H5.64a2 2 0 00-1.962 1.608l-1.2 6A2 2 0 004.44 12H8v4a2 2 0 002 2 1 1 0 001-1v-.667a4 4 0 01.8-2.4l1.4-1.866a4 4 0 00.8-2.4z" transform="translate(0, 20) scale(1, -1)" />
          </svg>
        );
      case 2:
        return (
      ...
      case 3:
        return (
          <svg className="w-8 h-8" fill="currentColor" viewBox="0 0 20 20">
            <path d="M2 10.5a1.5 1.5 0 003 0v-6a1.5 1.5 0 00-3 0v6zM6 10.333v-5.43a2 2 0 011.105-1.79l.05-.025A4 4 0 018.945 3h5.416a2 2 0 011.962 1.608l1.2 6A2 2 0 0115.56 13H12v4a2 2 0 01-2 2 1 1 0 01-1-1v-.667a4 4 0 00-.8-2.4L6.8 13.067a4 4 0 01-.8-2.4z" transform="translate(20, 20) scale(-1, -1)" />
          </svg>
        );
    }
  };
