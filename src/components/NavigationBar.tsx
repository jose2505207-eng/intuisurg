...
export function NavigationBar({ orderNumber, onViewBOM, onViewSignOff, onViewProcessLogs, onOpenAssistant }: NavigationBarProps) {
  return (
    <div style={{ backgroundColor: 'rgb(37, 99, 235)' }} className="px-6 py-4 text-white flex items-center justify-between flex-shrink-0">
      <div>
        <h1 className="text-xl font-bold tracking-wide">Debug Panel</h1>
      ...
      <div className="flex gap-2">
        ...
        <Button onClick={onOpenAssistant} size="sm" className="bg-blue-600 hover:bg-blue-700 text-white border-0 font-semibold">
